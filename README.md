...
本版本demo演示：https://chat-production-bfc8.up.railway.app/
原版demo演示：https://fagedongxi.com
...
2. 输入房间号（2-32个字符）和密码
3. 确认密码后点击"创建"
4. 创建成功后会显示房间链接，可复制分享给其他人
5. 其他用户访问该链接并输入密码即可加入房间

> 在线创建的房间会自动保存到 `room_pwd.json` 文件中，服务重启后仍然有效。
